...
Lignes de basses ouvertes à ta personnalité, Bienvenu(e) à toi!'),
--3
...
Secteur Touraine Maine et loire'),
--6
...
--7
('Musiciens',
'Cherche musicien retraite amateur accordeonniste ou synthe pour rejoindre petit groupe de benevoles pour aller dans maison de retraite.'),
--8
