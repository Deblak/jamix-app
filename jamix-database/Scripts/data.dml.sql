...
('Dijon', '21231'), ('Lyon', '69001'), ('Roubaix', '59512'), ('Auxerre', '89000'), ('Montpellier', '34000'), ('Bordeaux', '33000'), ('Nantes', '44000'),
 ('Rennes', '35000'), ('Strasbourg', '67000'), ('Paris', '75001'), ('Marseille', '13000'), ('Toulouse', '31000');
...
('Groupe de Tourcoing cherche son chanteur',
 ...
 (SELECT id FROM t_locations WHERE zip_code = '59599'),
...
('Musicien cherche musicien',
 ...
 (SELECT id FROM t_locations WHERE zip_code = '21231'),
...
('Musiciens bénévoles',
 ...
 (SELECT id FROM t_locations WHERE zip_code = '59512'),
...
('Jam session jazz et improvisation',
 ...
 (SELECT id FROM t_locations WHERE zip_code = '13000'),
