...
-- (Warning) Need to create user 'test.postman@gmail.com' and 'test.vuejs@gmail.com'
...
('Cherche musiciens jazz',
 ...
 'sophie.vue@gmail.com', '1cce5c2c-d3bd-48ed-be4e-a4be6ed60174.jpg',
 ...
 (SELECT id FROM t_accounts WHERE email = 'test.vuejs@gmail.com')),
 
 ('Formation groupe métal',
 'Cherche des musiciens pour monter un groupe de métal, influence heavy et thrash.',
 'frederic.vue@gmail.com', 'c2a70c79-609b-4871-a3df-8fe7478ee062.jpg',
 ...
 'pixelvue@gmail.com', '9d17d9ad-25e8-4faa-af18-373041466909.jpg',
...
id_account) VALUES ('ZOOMBEE X cherche son bassiste',
 ...
 'julien.martin16@gmail.com', NULL,
 ...
 (SELECT id FROM t_goals WHERE goal_type = 'Monter un groupe'),
 (SELECT id FROM t_accounts WHERE email = 'test.postman@gmail.com')),

('Cherche musiciens funk',
 'Je cherche des musiciens jazz, funk ou rock pour jouer en groupe et progresser ensemble.',
 'sophie.petit38@gmail.com', NULL,
 (SELECT id FROM t_locations WHERE zip_code = '16100'),
 (SELECT id FROM t_instruments WHERE instrument_name = 'Clavier'), 
 (SELECT id FROM t_styles WHERE style_name = 'Jazz'), 
 (SELECT id FROM t_goals WHERE goal_type = 'Jam Session'),
...
('Groupe de Tourcoing cherche son chanteur',
 ...
 'antoine.bernard13@gmail.com', NULL,
...
('Guitariste cherche groupe de rock',
 ...
 'antoine.lambert@gmail.com', NULL,
...
('Séance de jam rock',
 ...
 'rocknrollsession@gmail.com', NULL,
(SELECT id FROM t_locations WHERE zip_code = '69001'),
(SELECT id FROM t_instruments WHERE instrument_name ='Batterie'), 
(SELECT id FROM t_styles WHERE style_name ='Rock'), 
(SELECT id FROM t_goals WHERE goal_type = 'Jam Session'),
